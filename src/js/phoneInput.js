  ...
  var intlTelInput = (function () {
    ...
    Iti.prototype = {
      ...
      _generateMarkup: function () {
        ...
        this.flagsContainer = this._create(
          "div",
          "flag-container",
          null,
          wrapper
        ...
        // selected flag
        this.selectedFlag = this._create(
          "div",
          "selected-flag",
          null,
          this.flagsContainer
        );
        this.selectedFlagInner = this._create(
          "div",
          "iti-flag",
          null,
          this.selectedFlag
        );
        this.triangle = this._create(
          "div",
          "iti-arrow",
          null,
          this.selectedFlag
      ...
      _highlightListItem: function (listItem) {
        var highlightedCountries =
          this.countryList.querySelectorAll(".highlight");
